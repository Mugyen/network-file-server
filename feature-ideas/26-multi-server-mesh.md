...
## Summary
Run multiple WiFi File Server instances on different machines and they automatically discover each other, forming a mesh. Browse files across all servers from any single UI. Distributed file sharing for homes, offices, or events.
...
- Auto-discover other WiFi File Server instances on the LAN
