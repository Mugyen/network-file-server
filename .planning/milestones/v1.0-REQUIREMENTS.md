...
- [x] **FILE-01**: User can browse files in the shared folder
- [x] **FILE-02**: User can navigate into subdirectories with breadcrumb trail
- [x] **FILE-03**: User can upload multiple files via drag-and-drop with individual progress bars
- [x] **FILE-04**: User can download individual files
- [x] **FILE-05**: User can select multiple files and download as ZIP
- [x] **FILE-06**: User can delete files with confirmation dialog
- [x] **FILE-07**: User can rename files inline
- [x] **FILE-08**: User can create new folders
- [x] **FILE-09**: User can batch delete selected files
...
- [x] **SRCH-01**: User can search files by name (instant client-side filtering)
- [x] **SRCH-02**: User can filter by file type category (images, videos, docs, audio, archives, code)
- [x] **SRCH-03**: User can sort by name, size, date modified, type

### Media Preview

- [x] **MEDP-01**: User can preview images in a lightbox with zoom
- [x] **MEDP-02**: User can stream video/audio in-browser with seeking
- [x] **MEDP-03**: User can view PDFs in embedded viewer
- [x] **MEDP-04**: User can view code files with syntax highlighting
- [x] **MEDP-05**: User can view markdown files rendered as HTML

### Real-Time

- [x] **RTME-01**: WebSocket connection established on page load
- [x] **RTME-02**: Toast notifications shown for file uploads/downloads
- [x] **RTME-03**: Shared text clipboard (scratchpad) synced across all connected devices
- [x] **RTME-04**: User can create a file request with description visible to all devices
- [x] **RTME-05**: User can fulfill a file request by uploading

### UI/UX

- [x] **UIUX-01**: Dark mode with system preference detection and manual toggle
- [x] **UIUX-02**: Responsive layout works on mobile devices
- [x] **UIUX-03**: File type icons displayed for all files
...
| MEDP-01 | Phase 3 | Complete |
| MEDP-02 | Phase 3 | Complete |
| MEDP-03 | Phase 3 | Complete |
| MEDP-04 | Phase 3 | Complete |
| MEDP-05 | Phase 3 | Complete |
| UIUX-01 | Phase 3 | Complete |
| RTME-01 | Phase 4 | Complete |
| RTME-02 | Phase 4 | Complete |
| RTME-03 | Phase 4 | Complete |
| RTME-04 | Phase 4 | Complete |
| RTME-05 | Phase 4 | Complete |
