...
**Success Criteria** (what must be TRUE):
  1. User can run `network-file-server mount ./files --server <url>` and the agent connects to the relay, registers a mount code, and begins serving files through the tunnel
