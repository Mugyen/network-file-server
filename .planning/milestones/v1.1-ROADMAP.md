...
**Milestone Goal:** Add access control (password, read-only, receive mode), expiring share links, and device discovery to the Network File Server.

- [x] **Phase 5: Access Control** - Password protection, read-only mode, receive mode, and CLI validation for server access modes (completed 2026-03-09)
- [x] **Phase 6: Expiring Share Links** - Generate, distribute, and manage time-limited share links for files (completed 2026-03-09)
- [x] **Phase 7: Device Discovery** - Real-time panel showing connected devices with type, status, and self-identification (completed 2026-03-09)
...
Plans:
- [ ] 06-01-PLAN.md -- ShareLinkService, share router, Jinja2 templates, auth bypass (backend)
- [ ] 06-02-PLAN.md -- ShareDialog, ShareLinksPanel, FileRow share button (frontend)
...
Plans:
- [ ] 07-01-PLAN.md -- DeviceType enum, DeviceInfo dataclass, extended ConnectionManager, device_list WS message (backend)
- [ ] 07-02-PLAN.md -- DevicesPanel slide-out, useWebSocket device tracking, header button with badge (frontend)
...
| 5. Access Control | 3/3 | Complete   | 2026-03-09 | - |
| 6. Expiring Share Links | 2/2 | Complete   | 2026-03-09 | - |
| 7. Device Discovery | 2/2 | Complete   | 2026-03-09 | - |
